...
当前状态：G00、G01 已关闭；G02 正在执行。最终 readiness audit 发现 I-0017 lab 部署仍会
拒绝已验证的 evidence-only descendant HEAD，因此 I-0017 已前向重开并成为唯一 active
Iteration；I-0020 仍保持 planned，当前不得运行统一候选 Gate Eval。
