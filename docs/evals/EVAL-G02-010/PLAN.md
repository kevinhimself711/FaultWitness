# EVAL-G02-010 Plan — Second Replacement Unified Candidate Orchestration

## Purpose

在一个 post-I-0024 不可变候选上执行十四个冻结 Gate phases。EVAL-G02-008 保持永久失败
历史；本 Eval 不继承其 blocked phase，也不改写任何旧 artifact。
...
manifest 加 EVAL-G02-001 至 EVAL-G02-004。失败与治理纠错 Evals 只作为前向历史引用，
不增加该冻结 N。
...
- I-0025 不新增产品行为、runner、fixture、framework、threshold、workflow 或 sample。
