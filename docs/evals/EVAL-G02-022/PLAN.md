# EVAL-G02-022 Plan — Eighth Replacement Unified Candidate Orchestration

## Purpose

在一个 post-I-0036 不可变候选上执行十四个冻结 Gate phases。EVAL-G02-005、008、010、
012、014、016、018、020 保持永久失败历史；本 Eval 不继承其失败 phase，也不改写旧 artifact。
...
- I-0037 不新增产品行为、runner、fixture、framework、threshold、workflow 或 sample。
