# EVAL-G02-016 Plan — Fifth Replacement Unified Candidate Orchestration

## Purpose

在一个 post-I-0030 不可变候选上执行十四个冻结 Gate phases。EVAL-G02-005、008、010、012、
014 保持永久失败历史；本 Eval 不继承其 blocked phase，也不改写任何旧 artifact。
...
- I-0031 不新增产品行为、runner、fixture、framework、threshold、workflow 或 sample。
