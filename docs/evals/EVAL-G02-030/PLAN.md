# EVAL-G02-030 Plan — Post-Trace-Binding Unified Candidate Gate Attempt

## Purpose

Execute the unchanged fourteen-phase G02 Gate Eval on the immutable post-C-G02-004 candidate.
All prior failed Eval assets remain immutable and are not rebound or counted as new-candidate
evidence.
