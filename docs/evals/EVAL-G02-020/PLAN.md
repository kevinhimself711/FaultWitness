# EVAL-G02-020 Plan — Seventh Replacement Unified Candidate Orchestration

## Purpose

在一个 post-I-0034 不可变候选上执行十四个冻结 Gate phases。EVAL-G02-005、008、010、
012、014、016、018 保持永久失败历史；本 Eval 不继承其 blocked phase，也不改写旧 artifact。
...
manifest 加 EVAL-G02-001 至 EVAL-G02-004；失败与纠错 Eval 不增加冻结 N。
...
- I-0035 不新增产品行为、runner、fixture、framework、threshold、workflow 或 sample。
