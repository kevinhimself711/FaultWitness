# EVAL-G02-018 Plan — Sixth Replacement Unified Candidate Orchestration

## Purpose

在一个 post-I-0032 不可变候选上执行十四个冻结 Gate phases。EVAL-G02-005、008、010、
012、014、016 保持永久失败历史；本 Eval 不继承其 blocked phase，也不改写任何旧 artifact。
...
- I-0033 不新增产品行为、runner、fixture、framework、threshold、workflow 或 sample。
