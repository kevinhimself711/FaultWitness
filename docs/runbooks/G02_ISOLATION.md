...
EVAL-G02-005, EVAL-G02-008, and EVAL-G02-010 are immutable failed history. Replacement
orchestration writes new Gate artifacts only under `EVAL-G02-012`; no runner may select a terminal
